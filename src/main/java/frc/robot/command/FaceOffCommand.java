...
public class FaceOffCommand extends CommandBase {
    ...
    public void initialize() {
        ...
        pidController = new PIDController(0.4, 0, 0.02);
    ...
    public boolean isFinished() {
        ...
        if (angle < (1.5 - (0.005 * limelightDistance)) && commandStartTime + 1500 < System.currentTimeMillis() && limeLightValues.hasTarget() || commandStartTime + 3000 < System.currentTimeMillis()) {
