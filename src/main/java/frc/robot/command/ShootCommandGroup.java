...
public class ShootCommandGroup extends SequentialCommandGroup {
    ...
    public ShootCommandGroup() {
        ...
        new WaitCommand(0.6), new SmartDashboardCommand("Shoot Command Group", "Gate off"), new StorageCommand(true),     //gate open and 1st Ball
        new WaitCommand(0.5), new SmartDashboardCommand("Shoot Command Group", "Gate on"), new StorageCommand(false),
        new WaitCommand(1.1), new SmartDashboardCommand("Shoot Command Group", "Gate off"), new StorageCommand(true),     //gate open and 2nd Ball
        new WaitCommand(0.45), new SmartDashboardCommand("Shoot Command Group", "Gate on"), new StorageCommand(false),
        new WaitCommand(1.1), new SmartDashboardCommand("Shoot Command Group", "Gate off"), new StorageCommand(true),     //gate open and 3rd Ball
        new WaitCommand(0.45), new SmartDashboardCommand("Shoot Command Group", "Gate on"), new StorageCommand(false),
